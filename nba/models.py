...
class Stat(models.Model):
  ...
  x3_Point_Field_Goals_percent =models.CharField(max_length=100, blank=True, null=True)
  ...
  x2_Point_Field_Goals_percent =models.CharField(max_length=100, blank=True, null=True)
  ...
  Offensive_Rebounds_game = models.CharField(max_length=100, blank=True, null=True)
  Defensive_Rebounds_game =  models.CharField(max_length=100, blank=True, null=True)
